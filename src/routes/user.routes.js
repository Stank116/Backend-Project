...
import {registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, changeAccountDetails, changeUserAvatar, changeUserCoverImage, getChannelProfile} from "../controllers/user.controllers.js";
...
userRouter.route("/channel/: username").get(JWTverify, getChannelProfile)
